...
public class VmInOut {
    ...
    public static void main(String[] args) {
        ...
        do {
            // 메뉴 출력
//	       	System.out.println(coffeeNames[] + "(" +coffeePrice[] +"원)");
            ...
            // 밀크 커피 판매 가능 상태로 반환 처리
            // 입력한 동전이 300원 이상이면 판매가능 상태 "o"로 변환
            if (inCoin >= coffeePrice[2]) {
                isSale[0] = true;
                ...
                switch (menu) {
                    case 1:
                        // 자판기가 판매금액 회수
                        vmCoin += coffeePrice[0];
                        inCoin -= coffeePrice[0];
                        System.out.println(coffeeNames[0] + " 나왔습니다");
                }
                // 밀크커피 상태 체크
                if (inCoin >= coffeePrice[2]) {
                    isSale[0] = true;
                ...
                System.out.printf("%s (%d원) %s \n", coffeeNames[0], coffeePrice[0], isSale[0] ? "o" : "x");
                System.out.println("잔액 : " + inCoin);
            }
