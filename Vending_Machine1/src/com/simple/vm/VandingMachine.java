...
public class VandingMachine {
    ...
    public VandingMachine(Coin coin, DisplayPanel display, ReturnButton returnButton, ProductOutput output) {
        this.coin = coin;
    ...
    public static void main(String[] args) {
        ...
        VandingMachine vm = new VandingMachine(coin, display, returnButton, output);
